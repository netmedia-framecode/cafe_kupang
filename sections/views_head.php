...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_cafe_kupang']['name_page'])) {
                          if (!empty($_SESSION['project_cafe_kupang']['name_page'])) {
                            echo " - " . $_SESSION['project_cafe_kupang']['name_page'];
                          }
                        } ?>
</title>
